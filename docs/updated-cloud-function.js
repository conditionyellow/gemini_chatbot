// Google Cloud Functions (Node.js) - Updated for Persona System
...
// Cloud Functionsのエントリポイント関数
exports.chatbotProxy = async (req, res) => {
    // CORS設定
    ...
    // リクエストボディから情報を取得
    const { userMessage, chatHistory = [], modelId, persona } = req.body;
